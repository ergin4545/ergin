...
if(PEND){content=[{type:"text",text:t||"Bu fotoğrafı açıkla ve yorum yap"},{type:"image_url",image_url:{url:PEND}}];PEND=null;H.push({t:t||"[Fotoğraf]",r:"u"})}else{add(t,"u");H.push({t:t,r:"u"});content=t}
